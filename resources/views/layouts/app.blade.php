...
<body class="bg-[#F8FAFC] flex h-screen overflow-hidden text-slate-800">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header
            class="h-20 bg-white/80 backdrop-blur-md flex items-center justify-between px-10 sticky top-0 z-10 border-b border-slate-100">
            ...
            <div class="flex items-center space-x-6">
                <div class="relative cursor-pointer hover:bg-slate-50 p-2 rounded-full transition">
                    ...
                    <span
                        class="absolute top-1 right-1 bg-red-500 text-[10px] text-white w-4 h-4 flex items-center justify-center rounded-full border-2 border-white font-bold">3</span>
                </div>
                <div class="flex items-center space-x-3 pl-6 border-l border-slate-100">
                    ...
                    @else
                        <div
                            class="w-10 h-10 rounded-xl bg-slate-900 flex items-center justify-center font-bold text-white border border-slate-800 shadow-lg shadow-slate-200 uppercase">
                            @php
