...
<body class="bg-[#F1F5F9] flex h-screen overflow-hidden text-slate-800">
    ...
    <aside
        class="w-72 bg-[#0F172A] text-white flex flex-col transition-all duration-300 shadow-[4px_0_24px_rgba(0,0,0,0.4)] z-20">

        <div class="p-8 flex items-center space-x-4">
            <div
                class="bg-rose-600 w-12 h-12 rounded-2xl flex items-center justify-center shadow-lg shadow-rose-600/40 ring-4 ring-rose-600/10 transition-transform duration-500 hover:scale-110 hover:rotate-3">
        ...
        <div class="px-8 mt-4 mb-4 flex items-center space-x-2">
            ...
            <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest opacity-80">Management
                System</span>
        </div>
        ...
        <nav class="flex-1 px-4 space-y-1.5 overflow-y-auto custom-scrollbar">
            ...
            @if (auth()->guard('admin')->user()->isSuperAdmin())
                <div class="pt-4 pb-2 px-4">
                    <span class="text-[9px] font-black text-slate-600 uppercase tracking-[0.2em]">Super Admin
                        Only</span>
                </div>
        ...
        <div
            class="p-6 mx-4 mb-6 rounded-2xl bg-slate-900/50 border border-white/5 group transition-all duration-300 hover:bg-rose-500/10 hover:border-rose-500/20">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header
            class="h-20 bg-white flex items-center justify-between px-10 sticky top-0 z-30 border-b border-slate-200">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="relative group">
                    <div
                        class="w-11 h-11 rounded-xl bg-slate-100 border-2 border-slate-200 flex items-center justify-center text-slate-400 group-hover:border-rose-300 transition-all cursor-pointer">
