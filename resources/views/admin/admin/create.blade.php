...
@section('content')
    <div class="w-full mb-8 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-3xl font-extrabold text-slate-800 tracking-tight">Tambah Administrator</h2>
                <p class="text-slate-500 text-sm">Daftarkan administrator baru untuk mengelola sistem.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
        <div class="px-10 py-6 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
            <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Administrator Registration</h3>
            <span
                class="px-4 py-1 bg-white border border-slate-200 rounded-full text-[10px] font-bold text-rose-500 shadow-sm">
                STATUS: NEW
            </span>
        </div>
        ...
        <form action="{{ route('admin.admin.store') }}" method="POST" enctype="multipart/form-data" class="p-10">
            @csrf
                ...
                <div class="w-full lg:w-72 flex flex-col">
                    <div class="relative group mx-auto lg:mx-0 w-64 lg:w-full">
                        <div
                            ...
                            <img id="preview-img"
                                src="https://ui-avatars.com/api/?name=Admin&background=FFF1F2&color=E11D48&bold=true"
                    ...
                    <p class="text-center text-[10px] text-slate-400 mt-4 font-bold uppercase tracking-tighter">
                        <i class="fas fa-info-circle mr-1 text-rose-600"></i> JPG, PNG, JPEG (Maks. 2MB)
                    </p>
                </div>
                ...
                <div class="flex-1">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                        ...
                        <div class="space-y-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}"
                                    class="w-full pl-7 py-2 bg-transparent border-b-2 border-slate-100 focus:border-rose-500 focus:outline-none text-base text-slate-700 font-bold transition-all"
                                    placeholder="admin@sistem.com" required>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 group md:col-span-2">
                            <label
                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Akses
                                Role</label>
                            <div class="relative">
                    ...
                    <div class="mt-16 flex flex-col sm:flex-row justify-end gap-4">
                        ...
                        <button type="submit"
                            class="order-1 sm:order-2 bg-rose-600 hover:bg-rose-700 text-white font-black py-4 px-14 rounded-2xl transition-all shadow-lg shadow-rose-100 text-[10px] uppercase tracking-[0.2em] group">
                            Simpan Data
                            <i class="fas fa-save ml-2 group-hover:scale-125 transition-transform"></i>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const defaultAvatar = "https://ui-avatars.com/api/?name=Admin&background=FFF1F2&color=E11D48&bold=true";
