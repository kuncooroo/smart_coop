...
@section('content')
    <div class="w-full mb-8 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div>
                <h2 class="text-3xl font-extrabold text-slate-800 tracking-tight">Registrasi Kandang</h2>
                <p class="text-slate-500 text-sm">Input data infrastruktur dan konfigurasi otomasi awal.</p>
            </div>
        </div>
    </div>
    ...
    <div class="w-full bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
        <div class="px-10 py-6 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
            <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Infrastructure Setup</h3>
            <span
        ...
        <form action="{{ route('admin.kandang.store') }}" method="POST" enctype="multipart/form-data" class="p-10">
            @csrf
            ...
            <div class="flex flex-col lg:flex-row gap-16">
                <div class="w-full lg:w-72 flex flex-col">
                    <div class="relative group mx-auto lg:mx-0 w-64 lg:w-full">
                        <div
                            ...
                            <img id="preview-img"
                                src="https://ui-avatars.com/api/?name=Kandang+Baru&background=F1F5F9&color=64748B&bold=true"
                            ...
                            <div
                                ...
                                <span class="text-white text-[10px] font-black uppercase tracking-widest">Upload Foto</span>
                            </div>
                ...
                <div class="flex-1">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                        ...
                        <div class="space-y-2 group">
                            <label
                                class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Kode
                                Unik Kandang</label>
                            <div class="relative">
                                <i class="fas fa-fingerprint absolute left-0 top-1/2 -translate-y-1/2 text-slate-300"></i>
                                <input type="text" name="code" value="{{ old('code') }}"
                                    class="w-full pl-7 py-2 bg-transparent border-b-2 border-slate-100 focus:border-rose-500 focus:outline-none text-base text-slate-700 font-mono transition-all"
                                    placeholder="KND-001" required>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="time" name="timer_open" value="{{ old('timer_open') }}"
                        ...
                        <div class="space-y-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="time" name="timer_close" value="{{ old('timer_close') }}"
                                    class="w-full pl-7 py-2 bg-transparent border-b-2 border-slate-100 focus:border-rose-500 focus:outline-none text-base text-slate-700 font-bold transition-all">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2 md:col-span-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="current_chicken" value="{{ old('current_chicken', 0) }}"
                                    class="w-full pl-7 py-2 bg-transparent border-b-2 border-slate-100 focus:border-rose-500 focus:outline-none text-base text-slate-700 font-bold transition-all"
                                    placeholder="Jumlah ekor saat ini" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-16 flex flex-col sm:flex-row justify-end gap-4">
                        ...
                        <button type="submit"
                            ...
                            Simpan Kandang
                            <i class="fas fa-plus-circle ml-2 group-hover:rotate-90 transition-transform"></i>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const defaultAvatar = "https://ui-avatars.com/api/?name=Kandang+Baru&background=F1F5F9&color=64748B&bold=true";
