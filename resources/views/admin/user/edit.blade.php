    ...
    @section('content')
        ...
        <div class="w-full bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
            <div class="px-10 py-6 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
                ...
                <span class="px-4 py-1 bg-white border border-slate-200 rounded-full text-[10px] font-bold text-slate-500 shadow-sm">
            ...
            <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="p-10">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col lg:flex-row gap-16">
                    <div class="w-full lg:w-72 flex flex-col">
                        <div class="relative group mx-auto lg:mx-0 w-64 lg:w-full">
                            <div class="w-full aspect-square rounded-[3rem] bg-slate-50 border-4 border-white shadow-xl overflow-hidden relative transition-all group-hover:ring-4 group-hover:ring-rose-100 ring-1 ring-slate-100">
                                ...
                                <div class="absolute inset-0 bg-slate-900/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all backdrop-blur-[2px]">
                                    <label for="profile" class="cursor-pointer bg-white text-rose-600 w-14 h-14 flex items-center justify-center rounded-2xl shadow-2xl hover:scale-110 transition-transform mb-2">
                                        <i class="fas fa-camera text-xl"></i>
                                    </label>
                                    <span class="text-white text-[10px] font-black uppercase tracking-widest">Update Photo</span>
                                </div>
                        ...
                        <div class="mt-8 space-y-3">
                            <div class="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center gap-4">
                                <div class="w-8 h-8 bg-slate-400 rounded-lg flex items-center justify-center text-white text-xs">
                    ...
                    <div class="flex-1">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Nama Lengkap</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Username</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Email Address</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">No. Handphone</label>
                                <div class="relative">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Jenis Kelamin</label>
                                <div class="relative">
                                    <i class="fas fa-venus-mars absolute left-0 top-1/2 -translate-y-1/2 text-slate-300"></i>
                                    <select name="jenis_kelamin" class="w-full pl-7 py-2 bg-transparent border-b-2 border-slate-100 focus:border-rose-500 focus:outline-none text-base text-slate-700 font-bold appearance-none cursor-pointer transition-all">
                            ...
                            <div class="space-y-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Password Baru (Opsional)</label>
                                <div class="relative">
                                ...
                                <p class="text-[9px] text-slate-400 font-medium italic">*Kosongkan jika tidak ingin mengubah password</p>
                            </div>

                            <div class="space-y-2 md:col-span-2 group">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.15em] group-focus-within:text-rose-600 transition-colors">Alamat Lengkap</label>
                                <div class="relative">
        ...
        <script>
            ...
            const defaultAvatar = "https://ui-avatars.com/api/?name={{ urlencode($user->nama_lengkap) }}&background=FFF1F2&color=E11D48&bold=true";
